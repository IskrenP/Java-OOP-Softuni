...
public class EngineImpl implements Engine{
    ...
    private String deliverySupplement(String[] data) {
        ...
        String type = data[0];
        return controller.deliverySupplement(type);
    }
    ...
    private String addPlayer(String[] data) {
        ...
        return controller.addPlayer(fieldName, playerType, playerName, nationality, strength);
    }

    private String dragPlayer(String[] data) {
        String fieldName = data[0];
        return controller.dragPlayer(fieldName);
    }

    private String calculateStrength(String[] data) {
        String name = data[0];
        return controller.calculateStrength(name);
    }
